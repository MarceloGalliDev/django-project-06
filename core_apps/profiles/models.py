...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone number"), max_length=30, default="+5544999990123")
    ...
    city = models.CharField(verbose_name=_("city"), max_length=180, default="Maringá", blank=False, null=False)
    photo_profile = models.ImageField(verbose_name=_("photo profile"), default="/profile_default.png")
